        ...
        <div class="card h-100 border-0 shadow-sm">
            ...
            @else
                <div class="card-img-top d-flex align-items-center justify-content-center"
                     style="height:170px;background:linear-gradient(135deg,#CAF0F8,#0077B6);font-size:56px;border-radius:12px 12px 0 0">
                    @if($package->type === 'beach') &#127958;
                    @elseif($package->type === 'island') &#127965;
                    @elseif($package->type === 'nature') &#127795;
                    @elseif($package->type === 'heritage') &#127981;
                    @else &#9968;
                    @endif
                </div>
            @endif
